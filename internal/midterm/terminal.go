...
type OnScrollbackFunc func(row int, ltc LockedTerminalContext)
...
func (v *Terminal) Lock() (unlock func(), ltc LockedTerminalContext) {
	v.mut.Lock()
	return func() { v.mut.Unlock() }, &v.ltc
}
